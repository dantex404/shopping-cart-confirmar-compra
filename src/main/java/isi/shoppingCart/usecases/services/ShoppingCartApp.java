...
public class ShoppingCartApp {
    ...
    public ShoppingCartApp() {
        ...
        deleteItemUseCase = new DeleteItemUseCase(cartRepository, productRepository);
    ...
    public OperationResult removeProductFromCart(int itemID) {
        return deleteItemUseCase.execute(itemID);
    }
}
